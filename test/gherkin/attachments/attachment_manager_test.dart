...
void main() {
  group('attach', () {
    test('saves attachment', () async {
      ...
      expect(
        manager.getAttachmentsForContext().first.mimeType,
        equals(mimeType),
      );
    ...
    test('saves attachment with context', () async {
      ...
      expect(
        manager.getAttachmentsForContext(context).first.data,
        equals(data),
      );
      expect(
        manager.getAttachmentsForContext(context).first.mimeType,
        equals(mimeType),
      );
      expect(
        manager.getAttachmentsForContext(context).first.context,
        equals(context),
      );
